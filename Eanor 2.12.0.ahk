...
#IfWinNotActive, snowskeleton@Battleship
`::
send {BACKSPACE}
return
...
::ccin::customer called in for service. advised to call Samsung for new ticket. cx understood
::extwcin::customer called in for service. advised to call extended warranty for new ticket. cx understood

::ssciu::Samsung called in for update on ticket
::extwciu::Samsung called in for update on ticket
